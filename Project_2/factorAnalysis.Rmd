...
Since the loc_x and loc_y have either 0 or negative values, logarithmic transformation would not be feasible.This also applied to minutes_remaining , seconds_remaining and shot_distance.
*did not look into Cook's D, perhaps there are outlying points?
